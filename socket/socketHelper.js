...
function emitTicketRejectNotification(io, buyerId, eventId, engName, rejectedReason) {
  io.to(buyerId).emit('notification', {
    event_id: eventId,
...
function emitOrganizerRejectionNotification(io, receiverId, requestId, rejectionReason) {
  io.to(receiverId).emit('notification', {
