...
document.addEventListener("DOMContentLoaded", function () {
  window.descQuill = new Quill("#editor", {
    theme: "snow",
  ...
  async (e) => {
    ...
    try {
      ...
      showToast(
        true,
        isEnglish
          ? "Organizer Request Submitted. Please wait for confirmation from admin."
          : "សំណើអ្នករៀបចំត្រូវបានបញ្ជូន។ សូមរង់ចាំការបញ្ជាក់ពីអ្នកគ្រប់គ្រង"
      );
